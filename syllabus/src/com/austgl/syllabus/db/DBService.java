...
public abstract class DBService<T> extends SQLiteOpenHelper {
	...
	public static final String COURSEID = "courseId";// the id column in the
														// server db
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String course_sql = "CREATE TABLE " + COURSE_NAME + sql + COURSEID
				+ " INTEGER," + CNO + " text, " + CNAME + " text, " + TNO
				+ " INTEGER, " + TNAME + " text, " + CADDRESS + " text, "
				+ CSTARTWEEK + " INTEGER, " + CENDWEEK + " INTEGER, "
				+ CWEEKDAY + " INTEGER, " + COURSEINDEX + " INTEGER)";

		// String teacher_course_sql =
		// "CREATE TABLE " + TEACHER_COURSE_NAME + sql + TEACHERID +
		// " INTEGER, " + CNAME + " text, " + CADDRESS
		// + " text, " + CSTARTWEEK + " INTEGER, " + CENDWEEK + " INTEGER, " +
		// CWEEKDAY + " INTEGER, "
		// + COURSEINDEX + " INTEGER)";

		String unuploaded_sql = "CREATE TABLE " + UNUPLOADED_NAME + sql
				+ UNUPLOADED_COURSE_ID + " INTEGER, " + ACTION_UNDO
				+ " INTEGER)";
