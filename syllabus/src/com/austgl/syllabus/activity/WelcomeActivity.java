...
import com.austgl.syllabus.adapter.ViewPagerAdapter;
...
public class WelcomeActivity extends Activity implements OnClickListener,
	...
	private static final int[] pics = { R.drawable.top_one, R.drawable.top_two,
			R.drawable.top_three, R.drawable.top_four, R.drawable.top_five,
			R.drawable.top_six };

	private static final int[] bottoms = { R.drawable.bottom_one,
			R.drawable.bottom_two, R.drawable.bottom_three,
			R.drawable.bottom_four, R.drawable.bottom_five,
			R.drawable.bottom_six };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < pics.length; i++) {
			...
			if (i == pics.length - 1) {
				...
				rl = (RelativeLayout) inflater.inflate(R.layout.lastwelcome,
						null);
