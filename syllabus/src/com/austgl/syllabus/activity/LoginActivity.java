		...
		case R.id.login:
			...
			if (!isTeacher) {
				...
				if (null != departmentName && !"".equals(departmentName)
						...
						&& null != gradeNum && !"".equals(gradeNum)
						&& null != universityName && !"".equals(universityName)
						&& null != majorName && !"".equals(majorName)) {
					Editor editor = preferences.edit();
					editor.putString(CommonConstants.UNIVERSITY_NAME,
							universityName);
					editor.putString(CommonConstants.DEPARTMENT_NAME,
							departmentName);
					...
					Toast.makeText(this, "班级不能为空，如只有一个班级，则填1",
				...
				if (null != departmentName && !"".equals(departmentName)
					...
					editor.putString(CommonConstants.UNIVERSITY_NAME,
							universityName);
					editor.putString(CommonConstants.TEACHER_NAME,
							departmentName);
