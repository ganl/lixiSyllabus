...
public class SetUpActivity extends Activity implements OnClickListener {
	...
	private void initViews() {
		...
		weekOfSemister = preference.getInt(CommonConstants.WEEKOFSEMISTER,
				CommonConstants.DEFAULT_WEEKOFSEMISTER);
		String weekNum = weekOfSemister + "";
		// Integer.toString(preference.getInt(CommonConstants.WEEKOFSEMISTER,
		// CommonConstants.DEFAULT_WEEKNUM));
		...
		tvFirstClassStartTime.setText(preference.getString(
				CommonConstants.FIRST_CLASS_START,
		...
		tvFirstClassEndTime.setText(preference.getString(
				CommonConstants.FIRST_CLASS_END,
		...
		tvSecondClassStartTime.setText(preference.getString(
				CommonConstants.SECOND_CLASS_START,
		...
		tvSecondClassEndTime.setText(preference.getString(
				CommonConstants.SECOND_CLASS_END,
		...
		tvThirdClassStartTime.setText(preference.getString(
				CommonConstants.THIRD_CLASS_START,
		...
		tvThirdClassEndTime.setText(preference.getString(
				CommonConstants.THIRD_CLASS_END,
		...
		tvFourthClassStartTime.setText(preference.getString(
				CommonConstants.FOURTH_CLASS_START,
		...
		tvFourthClassEndTime.setText(preference.getString(
				CommonConstants.FOURTH_CLASS_END,
		...
		tvFifthClassStartTime.setText(preference.getString(
				CommonConstants.FIFTH_CLASS_START,
		...
		tvFifthClassEndTime.setText(preference.getString(
				CommonConstants.FIFTH_CLASS_END,
		...
		tvSixthClassStartTime.setText(preference.getString(
				CommonConstants.SIXTH_CLASS_START,
		...
		tvSixthClassEndTime.setText(preference.getString(
				CommonConstants.SIXTH_CLASS_END,
		...
		if (null == preference.getString(CommonConstants.SMS_TEXT, null)
				|| "".equals(preference.getString(CommonConstants.SMS_TEXT,
						null))) {
			etSmsText.setText((CommonConstants.DEFAULT_SMSTEXT));
		} else {
			etSmsText.setText(preference.getString(CommonConstants.SMS_TEXT,
					null));
		}
	...
	public void onClick(View view) {
		...
		case R.id.tvRightT:
			...
			for (int i = 0; i < tvStartTimeList.size(); i++) {
				editor.putString(CommonConstants.STR_START_TIME[i],
						tvStartTimeList.get(i).getText().toString());
			}
			for (int i = 0; i < tvEndTimeList.size(); i++) {
				editor.putString(CommonConstants.STR_END_TIME[i], tvEndTimeList
						.get(i).getText().toString());
			}

			if (null != ivShieldChecked.getTag()) {
				editor.putBoolean(CommonConstants.SHIELDED, true);
				if (null == etSmsText.getText()
						|| "".equals(etSmsText.getText().toString())) {
					editor.putString(CommonConstants.SMS_TEXT,
							CommonConstants.DEFAULT_SMSTEXT);
					Log.i(LOGTAG, "nothing is inputted");
				}
				Log.i(LOGTAG, "something is there:"
						+ etSmsText.getText().toString());
				editor.putString(CommonConstants.SMS_TEXT, etSmsText.getText()
						.toString());
			} else {
			...
			if (weekOfSemister != preference.getInt(
	...
	public class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case SET_END_TIME:
				...
				Log.i(LOGTAG, "hour of Day is " + hourOfDay
						+ ", and minute is " + minute);
				dialog = new TimePickerDialog(SetUpActivity.this, callBack,
