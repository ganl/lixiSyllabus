...
public class Lunar {
	public static String[] CHINA_HOLIDAYS = { "五月初五", "八月十五" };

	public static String[] NATIONAL_HOLIDAYS = { "05-1", "05-2", "05-3",
			"10-1", "10-2", "10-3", "10-4", "10-5", "10-6", "10-7", "01-1" };
	...
	// lunar.getChinaWeekdayString(today.getTime().toString().substring(0,
	// 3)));// 计算输出星期几
	// }
}
